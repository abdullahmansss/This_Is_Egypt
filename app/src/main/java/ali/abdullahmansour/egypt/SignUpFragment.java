...
public class SignUpFragment extends Fragment
{
    ...
    public void SignUp(final String email, String password, final String title, final String hotline, final String specialty, final String category, final String address, final String image_url, final String fb)
    {
        auth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>()
                {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        ...
                        {
                            StoreNewUser(title,email,hotline,specialty,category,address,image_url,fb);
